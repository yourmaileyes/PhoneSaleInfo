...
<body>
<section id="section-regist" class="regist-wrap">
  <div class="section-overlay"></div>
    <div class="container regist center animated" data-animation="flipInY" data-animation-delay="1000">
      <div class="row">
	    <div class="col-md-8 col-md-offset-2">
		  <div class="col-md-10 col-md-offset-1 center section-title"><h3>注册PhoneSaleInfo用户</h3></div>
		  <div class="confirmation"><p><span class="fa fa-check"></span></p></div>
		    <form  class="regist-form support-form" action="regist.do" method="POST" onSubmit="return formObj.checkForm()"  >
			  <div class="col-lg-12"><span style="color: red;">${errmsg }</span>
				...
				<input type="password" name="password" class="input-field form-item field-name" placeholder="输入密码" />
		        <input type="password" name="password2"  required="required" class="input-field form-item field-name" placeholder="确认密码" />
           <!-- <input type="text" name="nickname" required="required" class="input-field form-item field-name" placeholder="您的昵称"/>
				<input type="text" name="email" required="required" class="input-field form-item field-name" placeholder="您的邮箱" > -->
                <button type="submit" value="注册" class="fancy-button button-line button-white large zoom subform">
				  注册用户
